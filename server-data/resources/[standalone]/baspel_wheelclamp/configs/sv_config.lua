...
-- Items/Inventory --
Config.CheckItem = false -- true or false, if you want to use wheel clamps as item // if you use Config.Framework = 'none' you should this let it be on false...
Config.ItemName = 'wheelclamp' -- name of the item which will be used
