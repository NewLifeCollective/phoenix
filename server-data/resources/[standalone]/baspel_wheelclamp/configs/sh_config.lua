...
-- Debug --
Config.Debug = true -- true or false if you want it

-- Base --
Config.Framework = 1 -- 1 - esx or 2 - qb or 3 - none, if none you have to set notify to other, allowed jobs to nil and you cant use items or inventory check
Config.FrameworkExport = 'es_extended' -- 'es_extended' or 'qb-core'
Config.Notify = 1 -- 1 - esx, 2 - qb or 3 - other
