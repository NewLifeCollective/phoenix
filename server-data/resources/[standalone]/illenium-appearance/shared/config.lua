...
Config.ClothingRooms = {
    {
        job = "police",
        coords = vector4(461.34, -997.35, 31.13, 193.4),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
            vector3(460.19, -997.26, 31.13),
        ...
        ["Male"] = {
            ...
            },
            {
                ...
                outfitData = {
                    ...
                    ["arms"] = {item = 200, texture = 0}, -- Arms
                    ["t-shirt"] = {item = 122, texture = 0}, -- T Shirt
                    ["vest"] = {item = 4, texture = 0}, -- Body Vest
                    ["torso2"] = {item = 318, texture = 0}, -- Jacket
                    ["shoes"] = {item = 51, texture = 0}, -- Shoes
                    ["accessory"] = {item = 0, texture = 0}, -- Neck Accessory
                    ["bag"] = {item = 0, texture = 0}, -- Bag
                    ["hat"] = {item = 10, texture = 0}, -- Hat
                    ["glass"] = {item = 0, texture = 0}, -- Glasses
        ...
        ["Female"] = {
            {
                ...
                outfitData = {
                    ...
                    ["vest"] = {item = 0, texture = 0}, -- Body Vest
                    ["torso2"] = {item = 189, texture = 0}, -- Jacket
