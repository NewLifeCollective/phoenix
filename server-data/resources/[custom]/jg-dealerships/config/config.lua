...
Config.FinancePayments = 90
Config.FinanceDownPayment = 0.1 -- 0.1 means 10%
Config.FinanceInterest = 0.03 -- 0.1 means 10%
...
Config.DealershipLocations = {
  ["pdm"] = {
    ...
    openManagement = {
      coords = vec3(-26.67, -1109.56, 27.27),
      size = 5
    },
    sellVehicle = {
      coords = vec3(-11.16, -1081.49, 27.05),
      size = 5
    },
    purchaseSpawn = vec4(-50.14, -1076.95, 26.64, 70.72),
    ...
    societyPurchaseJobWhitelist = { 'police' },
