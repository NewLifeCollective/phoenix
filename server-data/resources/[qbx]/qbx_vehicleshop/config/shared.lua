return {
    ...
    shops = {
        pdm = {
            ...
            vehicleSpawns = {
                vec4(-46.4451, -1112.8495, 26.6703, 68.5362),
                vec4(-52.4020, -1110.8362, 26.6703, 69.1535),
                vec4(-60.9059, -1117.7854, 26.6703, 336.4417),
                vec4(-15.5339, -1094.6742, 26.9896, 160.8691),
                vec4(-19.2405, -1105.7103, 26.9366, 160.5609),
                vec4(-50.5751, -1117.1444, 26.6702, 339.2827),
            },
            showroomVehicles = {
                { coords = vec4(-47.74, -1092.29, 27.3, 276.27), vehicle = 'bati' },
                { coords = vec4(-37.0647, -1093.1125, 27.3, 194.6867), vehicle = 'schafter2' },
                { coords = vec4(-42.38, -1101.61, 27.3, 24.8), vehicle = 'greenwood' },
                { coords = vec4(-49.7193, -1083.8997, 27.3, 71.2328), vehicle = 'vigero' },
                { coords = vec4(-54.73, -1096.87, 27.3, 218.55), vehicle = 'impaler' },
            },
        },
