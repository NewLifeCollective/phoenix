return {
    ...
    money = {
        ...
        ---@type Money
        moneyTypes = { cash = 100000, bank = 1000, crypto = 0 }, -- type = startamount - Add or remove money types for your server (for ex. blackmoney = 0), remember once added it will not be removed from the database!
    ...
    player = {
        hungerRate = 0.000001, -- Rate at which hunger goes down.
        thirstRate = 0.000001, -- Rate at which thirst goes down.
    ...
    server = {
        ...
        discord = 'discord.gg/gsrp', -- Discord invite link
    ...
    getSocietyAccount = function(accountName)
        return exports['nfs-billing']:getSocietyBalance(('society_$s'):format(accountName))
    end,

    removeSocietyMoney = function(accountName, payment)
        return exports['nfs-billing']:withdrawSociety(('society_%s'):format(accountName), amount)
    end,
