...
Config.Companies.Services = {
    {
        ...
        bossRanks = { "Captain" }, -- ranks that can manage the company
        location = {
            name = "Mission Row",
            coords = {
                x = 428.9,
    ...
    },
    {
        job = "tow",
        name = "Tow Truck",
        icon = "https://cdn.discordapp.com/attachments/1216098374953078854/1361009514136211756/image.png?ex=67fd3262&is=67fbe0e2&hm=9026430efd57244035f48f11a9ec528d5d3851d7e8412262624c0be985b1cec0&",
        canCall = true,
        canMessage = true,
        bossRanks = { "boss" },
        location = {
